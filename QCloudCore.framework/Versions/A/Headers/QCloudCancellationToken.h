 ...
 */
typedef void(^QCloudCancellationBlock)();
 ...
 */
@interface QCloudCancellationToken : NSObject
 ...
 */
- (QCloudCancellationTokenRegistration *)registerCancellationObserverWithBlock:(QCloudCancellationBlock)block;
