...
@class QCloudTask<__covariant ResultType>;
 ...
 */
@interface QCloudTaskCompletionSource<__covariant ResultType> : NSObject
 ...
 */
@property (nonatomic, strong, readonly) QCloudTask<ResultType> *task;
